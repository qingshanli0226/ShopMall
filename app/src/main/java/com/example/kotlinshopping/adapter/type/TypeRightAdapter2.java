...
import com.example.kotlinshopping.bean.Child;
import com.example.kotlinshopping.bean.HotProduct;
import com.example.kotlinshopping.bean.TypeResult;

import java.util.List;


public class TypeRightAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TypeRightAdapter2(Context mContext, List<TypeResult> result) {
    ...
    class OrdinaryViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(Child child, final int position) {
            //加载图片
            Glide.with(mContext)
                    .load(Constants.BASE_URl_IMAGE +child.getPic())
                    .into(iv_ordinary_right);
            //设置名称
            tv_ordinary_right.setText(child.getName());
    ...
    class HotViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(final List<HotProduct> hot_product_list) {

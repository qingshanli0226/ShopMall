 ...
 */
class SeckillRecyclerViewAdapter(private val mContext: Context, private val data: ResultBean.Result.SeckillInfo) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private val list: List< ResultBean.Result.SeckillInfo.X>?
    ...
    internal inner class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun setData(position: Int) {
            ...
            tvCoverPrice.text = "￥" + listBean.coverPrice
            tvOriginPrice.text = "￥" + listBean.originPrice
            Glide.with(mContext)

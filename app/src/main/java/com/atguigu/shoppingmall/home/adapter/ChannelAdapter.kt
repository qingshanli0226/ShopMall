 ...
 */
class ChannelAdapter(private val mContext: Context, private val channel_info: List<ResultBean.Result.ChannelInfo>?) : BaseAdapter() {


    override fun getCount(): Int {
        return channel_info?.size ?: 0
    }
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        holer.tvChannel!!.text = channelInfoBean.channelName
        Glide.with(mContext)

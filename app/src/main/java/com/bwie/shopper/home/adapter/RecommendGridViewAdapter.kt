 ...
 */
class RecommendGridViewAdapter(private val mContext: Context, private val data: List<ResultBean.RecommendInfoBean>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        holder.tvPrice!!.text = "￥" + recommendInfoBean.cover_price!!
        return convertView
    }
